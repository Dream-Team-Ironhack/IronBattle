...
public class Warrior extends Character implements Attacker{
    ...
    public void attack(Character character) {
        ...
        if (randomAttack == 1 || this.stamina < 5) {
           ...
           stamina++;
            System.out.println( this.getName() +" has done a weak attack to "+ character.getName() + ",dealing " + (strength/2) +" points of damage, and his remaining HP are "+ character.getHp());
